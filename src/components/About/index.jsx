                        ...
                        <div className="row">
                            ...
                            <div className="col-md-6">
                             <h1>HELLO!</h1>
                                ...
                                <p>Beyond working on web apps, I do enjoy a vibrant host of activities.  I am an established multi instrumentalist and love to get together with friends to learn a few songs and have a great time playing them.  Like any great red blooded nerd, I also enjoy playing video games with friends in my free time (lately games like Among Us have stolen my fancy).  I also love to cook, so if you have a favorite recipe, I'd love to hear about it!</p>
